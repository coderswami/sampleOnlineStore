...
describe('Controller: OrderDetailController', function () {
	...
	beforeEach(inject(function ($state) {
		...
		order = {_id: '1337id', name: 'admin', active: true};
	}));
	...
	it('should have a user property which is the current order', function () {
