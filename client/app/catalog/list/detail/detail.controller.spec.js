...
describe('Controller: CatalogDetailController', function () {

	// load the controller's module
	beforeEach(module('sampleOnlineStoreApp.list.detail'));
	...
	beforeEach(inject(function ($state) {
		...
		catalog = {_id: '1337id', name: 'admin', active: true};
	}));

	// Initialize the controller and a mock scope
	beforeEach(inject(function ($controller) {
		controller = $controller('CatalogDetailController', {
			user: user
		});
	}));
	...
	it('should have a user property which is the current catalog', function () {
